...
class KohakuJointStatesIntegratorNode(object):
    def __init__(self):
        rospy.init_node('kohaku_jointstates_integrator_node')

        # parameters
        self._left_group_name = rospy.get_param('~left_group_name', 'kohaku_left')
        self._right_group_name = rospy.get_param('~right_group_name', 'kohaku_right')
