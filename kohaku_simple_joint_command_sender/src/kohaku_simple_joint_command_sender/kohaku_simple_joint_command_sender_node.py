...
import copy
import sys
from kohaku_simple_joint_command_sender.msg import SimpleJointTrajectory
from control_msgs.msg import FollowJointTrajectoryAction, FollowJointTrajectoryGoal
from trajectory_msgs.msg import JointTrajectoryPoint


class KohakuSimpleJointCommandSenderNode(object):
    def __init__(self):
        rospy.init_node('kohaku_simple_joint_command_sender_node')
